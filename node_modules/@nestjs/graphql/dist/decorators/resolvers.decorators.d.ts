...
export declare function createResolverDecorator(resolver?: Resolvers | string): (name?: string) => any;
export declare function createPropertyDecorator(propertyName?: string): MethodDecorator;
export declare function createDelegateDecorator(propertyName?: string): MethodDecorator;
